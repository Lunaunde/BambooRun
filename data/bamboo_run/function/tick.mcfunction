...
execute as @a run attribute @s generic.fall_damage_multiplier base set 0
...
execute if score #gamemaode number matches 0 if score #gametime number matches 1.. run function bamboo_run:gamemode/duel
